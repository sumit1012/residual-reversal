...
```bash
INIT=$(node "C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/get-shit-done/templates/spec.md.
