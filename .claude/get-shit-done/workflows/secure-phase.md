...
```
Agent(
  prompt="Read C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/get-shit-done/templates/SECURITY.md`
