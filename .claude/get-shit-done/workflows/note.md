...
- **Global scope**: `C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/notes/`)
...
2. Glob `C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/notes/` — works in any directory
