...
The keys live in `.claude/settings.json` (project) or `C:/Users/thakk/Documents/JOb search/wallstreetquants/Project_Residual_Reversal/.claude/settings.json` (global) — **not** in `.planning/config.json`:
